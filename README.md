...
<div align="center" style="background:#0a0a0a; color:#fff; border-radius:18px; padding:38px; box-shadow:0 0 26px #00fff9,0 0 12px #aaa;">
  ...
  <p style="font-size:1.12em;">
    <br>
    <strong>GitHub:</strong> <a href="[https://github.com/Fex-Ai](https://github.com/Fex-Ai)" style="color:#00ffff;">Fex-Ai</a> <br>
    <strong>Email:</strong> <a href="mailto:rodrigoisonline@gmail.com" style="color:#00ffff;">rodrigoisonline@gmail.com</a> <br>
     <strong>Coordenated by GitHub:</strong> <a href="https://github.com/rodrigoisonline" style="color:#00ffff;">rodrigoisonline</a>
  </p>
